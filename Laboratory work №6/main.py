...
def main(current_m):
    ...
    x1 = [x1_min, x1_min, x1_min, x1_min, x1_max, x1_max, x1_max, x1_max, -1.73 * deltax1 + x01, 1.73 * deltax1 + x01, x01, x01,
          x01, x01, x01]
    x2 = [x2_min, x2_min, x2_max, x2_max, x2_min, x2_min, x2_max, x2_max, x02, x02, -1.73 * deltax2 + x02, 1.73 * deltax2 + x02,
          x02, x02, x02]
    x3 = [x3_min, x3_max, x3_min, x3_max, x3_min, x3_max, x3_min, x3_max, x03, x03, x03, x03, -1.73 * deltax3 + x03,
    ...
    def func(X1, X2, X3):
        y = 3.2 + 9.1 * X1 + 4.1 * X2 + 3.7 * X3 + 2.1 * X1 * X1 + 0.8 * X2 * X2 + 4.9 * X3 * X3 + 3.7 * X1 * X2 + \
            0.5 * X1 * X3 + 1.0 * X2 * X3 + 0.3 * X1 * X2 * X3 + randrange(0, 10) - 5
        return y

    Y = [[func(list_for_a[j][0], list_for_a[j][1], list_for_a[j][2]) for i in range(m)] for j in range(15)]
